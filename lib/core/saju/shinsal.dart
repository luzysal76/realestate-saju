...
class JijangGan {
  // 원광만세력 기준 — 여기기(餘氣)·중기(中氣)·정기(正氣) 순서
  static const Map<String, List<String>> data = {
    '자': ['임', '계'],           // 壬(여기기) 癸(정기)
    '축': ['계', '신', '기'],     // 癸(여기기) 辛(중기) 己(정기)  ← 순서 수정
    '인': ['무', '병', '갑'],     // 戊(여기기) 丙(중기) 甲(정기)
    '묘': ['갑', '을'],           // 甲(여기기) 乙(정기)
    '진': ['을', '계', '무'],     // 乙(여기기) 癸(중기) 戊(정기)
    '사': ['무', '경', '병'],     // 戊(여기기) 庚(중기) 丙(정기)
    '오': ['병', '기', '정'],     // 丙(여기기) 己(중기) 丁(정기)  ← 丙 추가
    '미': ['정', '을', '기'],     // 丁(여기기) 乙(중기) 己(정기)
    '신': ['무', '임', '경'],     // 戊(여기기) 壬(중기) 庚(정기)
    '유': ['경', '신'],           // 庚(여기기) 辛(정기)
    '술': ['신', '정', '무'],     // 辛(여기기) 丁(중기) 戊(정기)
    '해': ['무', '갑', '임'],     // 戊(여기기) 甲(중기) 壬(정기)
  };
